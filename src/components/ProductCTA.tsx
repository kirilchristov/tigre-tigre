        ...
        <div className="space-y-4">
          <div>
            <div className="flex items-baseline gap-2">
              {promo.discount > 0 && (
                <span className="text-sm text-muted-foreground line-through">€{undiscountedTotal}</span>
              )}
          ...
          <Button asChild variant="destructive" size={compact ? 'default' : 'lg'} className="w-full group">
